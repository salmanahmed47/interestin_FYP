import 'package:event_managment/attendee/event_categories_screen.dart';
import 'package:firebase_core/firebase_core.dart';
import 'package:flutter/material.dart';
import 'package:firebase_auth/firebase_auth.dart';
import 'package:event_managment/admin/host_event.dart';
import 'package:event_managment/attendee/attendee_events_page.dart';
import 'package:event_managment/home/loading.dart';
import 'package:event_managment/portals/forgot_password.dart';
import 'package:event_managment/portals/register_view.dart';
  ...
  void attendeeLogin() async {
    ...
    if (email.isNotEmpty && password.isNotEmpty) {
      ...
      try {
        ...
        // ignore: use_build_context_synchronously
        Navigator.of(context).pushReplacement(MaterialPageRoute(builder: (context) {
          return const EventCategoriesScreen();
        }));
        _email.clear();
        _password.clear();
      } on FirebaseAuthException catch (e) {
