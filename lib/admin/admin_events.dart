...
import 'package:event_managment/admin/navigation.dart';
...
class _AdminEventsState extends State<AdminEvents> {
  ...
  late Stream<QuerySnapshot<Map<String, dynamic>>> _eventsStream = const Stream.empty();
  ...
  void _initializeEventsStream() {
    _eventsStream = FirebaseFirestore.instance.collection("events").where("email", isEqualTo: userEmail).snapshots();
  }
              ...
              builder: (context, snapshot) {
                ...
                return ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    final startDate = (event['startDate'] as Timestamp).toDate().toString();
                    final endDate = (event['endDate'] as Timestamp).toDate().toString();
                    ...
                    final images = event['images'] as List<dynamic>? ?? [];
                     final imageBytes = images.isNotEmpty ? base64Decode(images[0] ?? "") : null;
                    String sdate = DateFormat('dd/MM/yyyy').format(DateTime.parse(startDate));
                    sdate.split(" ");
                    String edate = DateFormat('dd/MM/yyyy').format(DateTime.parse(endDate));
                    sdate.split(" ");
                              ...
                              child: Container(
                                decoration: BoxDecoration(
                                  ...
                                  image: imageBytes != null
                                      ...
                                      : null,
                                  color: imageBytes == null ? Colors.white : null,
                                ),
                                child: Padding(
                                  padding: const EdgeInsets.all(20.0),
                                  child: Column(
                                                  ...
                                                  showDialog(
                                                    ...
                                                    builder: (context) {
                                                      return AlertDialog(
                                                        ...
                                                        content: const Text("Want to delete this event"),
                                                        actions: [
                                                          TextButton(
                                                            child: const Text(
                                                              'NO',
